...
public class OptionalReviseAdvanced {
    ...
    public static void main(String[] args) {
        ...
        //conditional methods
        //typical If() and Else() alternative
        ...
        Employee employee2 = empOptional.orElseGet(() -> {
            ...
            customEmp.setEmpId(44);
            customEmp.setEmpName("Custom Employee Name");
            customEmp.setEmpSalary(50000.00);
            customEmp.setContacts(EmpListService.contacts);
            return customEmp;
        });
